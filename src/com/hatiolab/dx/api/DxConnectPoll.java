...
public class DxConnectPoll {
	...
	public DxConnectPoll(String hostname) {
		this.hostname = hostname;
		this.port = DEFAULT_SERVICE_PORT;
	}
	
	public DxConnectPoll(String hostname, int port) {
		this.hostname = hostname;
		this.port = port;
	}
	...
	public void disconnect() throws IOException {
		...
		eventListener.onDxEvent(new Header(Type.DX_PACKET_TYPE_EVENT, Code.DX_EVT_DISCONNECT, Data.TYPE_NONE), null);
	}
